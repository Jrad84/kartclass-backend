...
from accounts.managers import CustomUserManager, ChargeManager, TransferManager
import jwt
import six
...
#     event = models.ForeignKey(Event, related_name="transfers", on_delete=models.SET_NULL)
#     amount = models.DecimalField(decimal_places=2, max_digits=9)
#     currency = models.CharField(max_length=25, default="aud")
...
#                 defaults[field] = convert_amount_for_db(defaults[field])  # assume in aud only
...
#     transfer = models.ForeignKey(Transfer, related_name="charge_fee_details", on_delete=models.SET_NULL)
#     amount = models.DecimalField(decimal_places=2, max_digits=9)
...
#     stripe_user = models.OneToOneField(
#         getattr(settings, "AUTH_USER_MODEL", "auth.User"),
#         null=True, on_delete=models.SET_NULL, related_name="stripe_customer"
#     )
...
#     def __unicode__(self):
#         return smart_str(self.stripe_user)
...
#             trial_days = TRIAL_PERIOD_FOR_USER_CALLBACK(stripe_user)
...
#     def charge(self, amount, currency="aud", description=None,
...
#     customer = models.ForeignKey(Customer, related_name="invoices", on_delete=models.SET_NULL)
...
#     stripe_id = models.CharField(max_length=255)
#     created_at = models.DateTimeField(default=timezone.now)
#     invoice = models.ForeignKey(Invoice, related_name="items", on_delete=models.SET_NULL)
#     amount = models.DecimalField(decimal_places=2, max_digits=9)
#     currency = models.CharField(max_length=10, default="usd")
#     period_start = models.DateTimeField()
#     period_end = models.DateTimeField()
